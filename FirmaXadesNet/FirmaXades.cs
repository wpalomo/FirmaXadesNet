...
namespace FirmaXadesNet
{
    public class FirmaXades
    {
        ...
        /// </summary>
        /// <param name="contenidoXML"></param>
        public void InsertarFicheroEnveloping(string contenidoXML)
        {
            Reference reference = new Reference();
        ...
        private void SellarEstadosCertificados()
        {
            ...
            signatureValueHash = XMLUtil.ComputeHashValueOfElementList((XmlElement)xmlNodoFirma, signatureValueElementXpaths);
